#ifndef COLD_BASE_SHELLCOLOR
#define COLD_BASE_SHELLCOLOR
...
class ColorControl {
 public:
  ...
  static constexpr const char* ColorReset() { return "\033[0m"; }
