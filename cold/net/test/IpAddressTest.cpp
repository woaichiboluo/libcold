...
using Cold::Net::IpAddress;

TEST_CASE("test ipv4 address") {
  CHECK(Cold::Net::IsLittleEndian());
  CHECK(!Cold::Net::IsBigEndian());
  IpAddress addr;
